...
function check() {
	...
	if(Number(pIndex)*10+Number(pIndex1)==c){
		alert("Your answer is: "+(Number(pIndex)*10+Number(pIndex1))+". It is correct!")
	}
	else{
		alert("Your answer is: "+(Number(pIndex)*10+Number(pIndex1))+". It is incorrect.")
	}
...
function position1(e){
	pos1.x = e.clientX-400;
	pos1.y = e.clientY-100;
}
